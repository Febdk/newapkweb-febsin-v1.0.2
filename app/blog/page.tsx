  ...
  const articles = [
    {
      ...
      excerpt: "Pelajari bagaimana warna dan gaya mencerminkan karakter Anda.",
    },
    {
      id: 2,
      ...
      excerpt: "Cerita dari awal berdirinya brand fashion lokal ini.",
    },
    {
      id: 3,
      ...
      category: "Tren Fashion",
      excerpt: "Prediksi tren streetwear yang akan mendominasi tahun depan.",
    },
    {
      id: 4,
      title: "Sustainable Fashion: Mengapa Penting?",
      slug: "sustainable-fashion",
      category: "Tentang Kami",
      excerpt: "Bagaimana Febsin berkomitmen pada mode ramah lingkungan.",
    },
  ];

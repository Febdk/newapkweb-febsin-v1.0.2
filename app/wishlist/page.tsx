            ...
            >
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="bg-orange-500 text-white px-3 py-1 rounded text-sm hover:bg-orange-600 transition-colors duration-300 hover:scale-105"
                >
                  Pindah ke Keranjang
                </button>
                <button
